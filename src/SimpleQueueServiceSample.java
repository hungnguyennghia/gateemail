 ...
 * (C:\\Users\\PC0353\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
...
public class SimpleQueueServiceSample {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
	     String keyID = "33333";//<your key id>
	     String secretKey = "R3333";//<your secret key>
